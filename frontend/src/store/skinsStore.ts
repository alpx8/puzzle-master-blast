...
const ALL_SKINS: BlockSkin[] = [
  ...
  },
  {
    id: 'diamond',
    name: 'Elmas',
    colors: ['#B9F2FF', '#89CFF0', '#7EC8E3', '#0077B6', '#023E8A', '#A2D2FF', '#CAF0F8'],
    premium: true,
    glow: true,
    adCost: 4,
  },
  {
    id: 'aurora',
    name: 'Aurora',
    colors: ['#00FF7F', '#00FA9A', '#7FFFD4', '#40E0D0', '#00CED1', '#5F9EA0', '#20B2AA'],
    premium: true,
    glow: true,
    adCost: 5,
  },
  {
    id: 'midnight',
    name: 'Gece Yarısı',
    colors: ['#191970', '#000080', '#00008B', '#0000CD', '#1E90FF', '#4169E1', '#6495ED'],
    premium: true,
    adCost: 5,
  },
];
